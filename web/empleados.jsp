                ...
                <%@page import="java.util.List" %>
                    <%@page contentType="text/html" pageEncoding="UTF-8" %>
                        <% HttpSession miSesion=request.getSession(); if (miSesion.getAttribute("usuario")==null) { response.sendRedirect("login.jsp"); } %>
                            ...
                            <% SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd"); Date ahora=new Date(); List<Empleado> listaEmpleados = (List) request.getSession().getAttribute("listaEmpleados");
                                %>
                                <!DOCTYPE html>
                                <html>
                                                ...
                                                <section class="insights">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="data">
                                                            ...
                                                            <h4>
                                                                <% int nuevosEmpleados=0; for (Empleado empleado : listaEmpleados) { if (empleado.getFechaContratacion().getMonth()==ahora.getMonth() && empleado.getFechaContratacion().getYear()==ahora.getYear()) { nuevosEmpleados++; } }%>
                                                                    <%= nuevosEmpleados%>
                                                            </h4>
                                                        </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="data">
                                                            ...
                                                            <h4>
                                                                <% double salariosTotales=0; for (Empleado empleado : listaEmpleados) { salariosTotales +=empleado.getSueldo(); }%>
